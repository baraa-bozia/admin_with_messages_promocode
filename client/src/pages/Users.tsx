...
export default function Users() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    password: '',
    role: 'user' as 'user' | 'admin' | 'employee' | 'superAdmin',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingUser) {
        ...
        // if (formData.password && formData.role=='superAdmin') {
        //   updateData.password = formData.password;
        // }
// فقط إذا أدخل المستخدم الحالي سوبر أدمن باسورد جديد
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                   ...
                   //need update to superAdmin
    // disabled={editingUser?.role !== 'admin'} 
    // placeholder={
    //   editingUser?.role !== 'admin'
    //     ? 'Only super admins can change password'
    //     : ''
    // }
                />
              </div>
              <div className="space-y-2">
                ...
                <Selectt
                  value={formData.role}
                  onValueChange={(value: 'user' | 'admin' | 'employee' | 'superAdmin') =>
